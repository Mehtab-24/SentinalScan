...
/**
 * HistoryTable — dark neon table with row glow on hover.
        ...
        <tbody>
          {scans.map((scan, idx) => (
            <tr
              ...
              style={{
                borderBottom: idx < scans.length - 1 ? '1px solid rgba(0,212,255,0.05)' : 'none',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background    = 'rgba(0,212,255,0.04)';
                e.currentTarget.style.boxShadow     = 'inset 3px 0 0 rgba(0,212,255,0.5)';
              }}
              onMouseLeave={(e) => {
                  ...
                  <div className="flex items-baseline gap-1">
                    <span
                      ...
                      style={{
                        ...
                        textShadow: `0 0 10px ${scoreColor(scan.overallScore)}80`,
                      }}
                    >
                      {scan.overallScore}
                    </span>
              ...
              <td className="px-6 py-4 text-right">
                <button
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.color       = '#00d4ff80';
                    e.currentTarget.style.boxShadow   = 'none';
                  }}
                >
                  View →
