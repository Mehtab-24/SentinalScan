...
/**
 * RepoSubmitForm — neon glass form for entering a GitHub repo URL.
 */
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          {/* Icon */}
          <div
            className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center justify-center w-6 h-6 rounded text-sm"
            style={{ color: '#00d4ff80' }}
          >
          ...
          <input
            ...
            className="input-neon w-full rounded-xl pl-12 pr-4 py-4 text-sm transition-all duration-200"
            style={{
            ...
            onFocus={(e) => {
              ...
              e.target.style.boxShadow   = '0 0 0 3px rgba(0,212,255,0.08), 0 0 20px rgba(0,212,255,0.1)';
            }}
            onBlur={(e) => {
